...
action_groups_ato1 = [
      ...
      [#3[a上張2]
          ...
          {'id': 3, 'position': 140, 'time': time_1},
          {'id': 4, 'position': 800, 'time': time_1},
          {'id': 5, 'position': 500, 'time': time_1},
      ...
      [#5[a上抓1]
          ...
          {'id': 2, 'position': 400, 'time': time_4},
          {'id': 3, 'position': 140, 'time': time_4},
          {'id': 4, 'position': 800, 'time': time_4},
          {'id': 5, 'position': 460, 'time': time_4},
          {'id': 6, 'position': 790, 'time': time_4}
      ],
      [#6[a上抓2]
          {'id': 1, 'position': 600, 'time': time_2},
          {'id': 2, 'position': 400, 'time': time_2},
          {'id': 3, 'position': 140, 'time': time_2},
          {'id': 4, 'position': 800, 'time': time_2},
          {'id': 5, 'position': 475, 'time': time_2},
      ...
      [#9[1上抓2]
          {'id': 1, 'position': 600, 'time': time_2},
          {'id': 2, 'position': 450, 'time': time_2},
          {'id': 3, 'position': 180, 'time': time_2},
          {'id': 4, 'position': 550, 'time': time_2},
          {'id': 5, 'position': 280, 'time': time_2},
          {'id': 6, 'position': 620, 'time': time_2}
      ],
      [#10[1上放]
          {'id': 1, 'position': 300, 'time': time_4},
          {'id': 2, 'position': 470, 'time': time_4},
          {'id': 3, 'position': 180, 'time': time_4},
          {'id': 4, 'position': 550, 'time': time_4},
          {'id': 5, 'position': 270, 'time': time_4},
          {'id': 6, 'position': 620, 'time': time_4}
      ],
      [#11[置中]
          {'id': 1, 'position': 300, 'time': time_4},
          {'id': 2, 'position': 500, 'time': time_4},
...
# 反轉動作組順序，從1點移動回a點
action_groups_1toa = list(reversed(action_groups_ato1))
