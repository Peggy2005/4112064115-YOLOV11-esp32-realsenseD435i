...
action_groups_ato4 = [
      ...
      [#4[a上張3]
          {'id': 1, 'position': 200, 'time': time_1},
          {'id': 2, 'position': 430, 'time': time_1},
          {'id': 3, 'position': 150, 'time': time_1},
          {'id': 4, 'position': 800, 'time': time_1},
          {'id': 5, 'position': 450, 'time': time_1},
          {'id': 6, 'position': 800, 'time': time_1}
      ],
      [#5[a上抓1]
      ...
      [#7[4上抓1]
          ...
          {'id': 2, 'position': 500, 'time': time_2},
          {'id': 3, 'position': 200, 'time': time_2},
          {'id': 4, 'position': 750, 'time': time_2},
          {'id': 5, 'position': 410, 'time': time_2},
          {'id': 6, 'position': 670, 'time': time_2}
      ],
      [#8[4上抓2]
          {'id': 1, 'position': 600, 'time': time_2},
          {'id': 2, 'position': 500, 'time': time_2},
          {'id': 3, 'position': 200, 'time': time_2},
          {'id': 4, 'position': 750, 'time': time_2},
          {'id': 5, 'position': 400, 'time': time_2},
          {'id': 6, 'position': 680, 'time': time_2}
      ],
      [#9[4上放]
          {'id': 1, 'position': 300, 'time': time_2},
          {'id': 2, 'position': 500, 'time': time_2},
...
action_groups_4toa = list(reversed(action_groups_ato4))
